...
if IS_PRODUCTION and SECRET_KEY.startswith("django-insecure-"):
    raise ImproperlyConfigured(
        "DJANGO_SECRET_KEY must be configured in Coolify."
    )
...
if IS_PRODUCTION and not ALLOWED_HOSTS:
    raise ImproperlyConfigured(
        "DJANGO_ALLOWED_HOSTS must be configured in Coolify."
    )
...
# Let Coolify/Traefik perform the HTTP-to-HTTPS redirect.
# This prevents internal health checks from receiving HTTP 301.
